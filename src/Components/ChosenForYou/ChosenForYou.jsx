...
const ChosenForYou = () => {
  const { ChosenForYou } = useContext(ThemeContext);
  const products = ChosenForYou.slice(0, 12);
  // const products = MostFavorite
  const isLoading = !ChosenForYou || ChosenForYou.length === 0;
  ...
  return (
    <section
      className="overflow-hidden  pt- pb-16 "
