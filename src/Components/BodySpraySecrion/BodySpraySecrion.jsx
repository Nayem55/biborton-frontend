...
const BodySpraySecrion = () => {
  const { bodyspray } = useContext(ThemeContext);
  const products = bodyspray?.slice(4, 10);
  // const products = bodyspray
  // console.log(bodyspray);

  const isLoading = !bodyspray || bodyspray.length === 0;
...
export default BodySpraySecrion;
