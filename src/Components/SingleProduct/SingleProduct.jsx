      ...
      <div className="max-w-7xl mx-auto text-white/80  py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-1/2 text-center md:text-left space-y-5">
          <p className="text-sm md:text-base font-medium text-">
            Warmth-enabling, Precieux embodies finesse and verve that transcends
            the conventional. This chypre amber collection is intelligently
            created with attention to detail. Honor the magic of uniquely
            clubbed zingy, spicy, and woody tones.
          </p>
