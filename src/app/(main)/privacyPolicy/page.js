export const metadata = {
  title: "Privacy Policy - MYNT ",
  description: "Privacy Policy for MYNT .",
};
  ...
  return (
    <div className="p-[6%]">
      ...
      <div>
        ...
        <p className="font-bold my-4 text-accent">HOW LONG WE RETAIN YOUR DATA</p>
        <p>
        ...
        <p className="font-bold my-4 text-accent">CONTROLLING YOUR PERSONAL INFORMATION</p>
        <p>
